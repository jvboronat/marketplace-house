  ...
  return <footer className='navbar'>
      <nav className="navbarNav">
          ...
          <li className="navbarListItem" onClick={() => navigate('/')}>
                  ...
                  <p className={pathMatchRoute('/') ? 'navbarListItemActive' : 'navbarListName'}>Explore</p>
              </li>

              <li className="navbarListItem" onClick={() => navigate('/offers')}>
                  <OfferIcon fill={pathMatchRoute('/offers') ? '#2c2c2c'  : '#8c8c8c' }   width='36px' height='36px'/>
                  <p className={pathMatchRoute('/offers') ? 'navbarListItemActive' : 'navbarListName'}>Offers</p>
              </li>

              <li className="navbarListItem" onClick={() => navigate('/profile')}>
                  <PersonOutlineIcon fill={pathMatchRoute('/profile') ? '#2c2c2c'  : '#8c8c8c' }  width='36px' height='36px'/>
                  <p className={pathMatchRoute('/profile') ? 'navbarListItemActive' : 'navbarListName'}>Profile</p>
              </li>                            
          </ul>
